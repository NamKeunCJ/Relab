...
(
    ...
    est_bat character varying(13) COLLATE pg_catalog."default" NOT NULL DEFAULT 'Habilitado'::character varying,
    status boolean NOT NULL DEFAULT true,
    created_at timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    update_at timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    deleted_at timestamp without time zone,
...
(
    pot_car double precision NOT NULL DEFAULT 0,
    id_pro integer NOT NULL,
...
(
    ...
    est_inv character varying(13) COLLATE pg_catalog."default" NOT NULL DEFAULT 'Habilitado'::character varying,
...
(
    ...
    est_pan character varying(13) COLLATE pg_catalog."default" NOT NULL DEFAULT 'Habilitado'::character varying,
...
(
    ...
    cbat_pro character varying(2) COLLATE pg_catalog."default" NOT NULL,
    id_inv integer,
    est_pro character varying(13) COLLATE pg_catalog."default" NOT NULL DEFAULT 'Habilitado'::character varying,
    eje_pro character varying(6) COLLATE pg_catalog."default" NOT NULL DEFAULT 'F'::character varying,
    status boolean NOT NULL DEFAULT true,
    created_at timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    update_at timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    deleted_at timestamp without time zone,
...
ALTER TABLE IF EXISTS public.carga
    ADD CONSTRAINT carga_id_pro_fkey FOREIGN KEY (id_pro)
    REFERENCES public.proyecto (id_pro) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
